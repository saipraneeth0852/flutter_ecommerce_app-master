              ...
              children: <Widget>[
                ...
                Container(
                  child: Row(
                    ...
                    mainAxisAlignment: MainAxisAlignment.spaceBetween,
                    children: <Widget>[
                      TitleText(key: Key('productTitle'), text: "NIKE AIR MAX 200", fontSize: 25),
                      Column(
  ...
  Widget _description() {
    return Column(
      ...
      children: <Widget>[
        TitleText(
          text: "Available Size",
          fontSize: 14, key: Key('descriptionTitle'),
        ),
        SizedBox(height: 20),
